...
LoadImages:[module_num:1|svn_version:\'10372\'|variable_revision_number:7|show_window:True|notes:\x5B"Load the images by matching files in the folder against the unique text pattern \'.JPG\'"\x5D]
...
Smooth:[module_num:3|svn_version:\'10300\'|variable_revision_number:1|show_window:True|notes:\x5B\'Smooth the image using a Gaussian filter.\'\x5D]
...
IdentifyPrimaryObjects:[module_num:4|svn_version:\'10372\'|variable_revision_number:7|show_window:True|notes:\x5B\'Identify the tissue region using three-class Otsu.\'\x5D]
...
MeasureImageAreaOccupied:[module_num:5|svn_version:\'10300\'|variable_revision_number:2|show_window:True|notes:\x5B\'Measure the area occupied by the tissue region.\'\x5D]
    Select objects to measure:Tissue
    Retain a binary image of the object regions for use later in the pipeline (for example, in SaveImages)?:No
    Name the output binary image:Stain

ExportToSpreadsheet:[module_num:6|svn_version:\'10251\'|variable_revision_number:7|show_window:True|notes:\x5B\'Export any measurements to a comma-delimited file (.csv). Since the tissue area is an image measurement, it is included in the per-image file.\'\x5D]
